...
using ProWPF.Modules.CustomControls.ViewModels;
using ProWPF.Services.Interfaces;

using Xunit;

namespace ProWPF.Modules.CustomControls.Tests.ViewModels
{
  public class ViewAViewModelFixture
  {
    ...
    {
      var vm = new CustomToolTipViewModel(_regionManagerMock.Object, _messageServiceMock.Object);
